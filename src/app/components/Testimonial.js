        ...
        <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
            <div className='border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0'>
                <div className='text-center flex flex-col items-center gap-1'>
                    ...
                    src='/user.jpg' width={80} height={80} alt='profile'/>
                    <h2 className='text-gray-500 font-black text-[20px]'>Elsa Doe</h2>
                    <p>CEO & Founder Invision</p>
                    <Image className='inline-block py-2'
                     src='/quotes.svg' width={30} height={30} alt='quotes'/>
                    <p className='max-w-[200px] text-gray-500'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras iaculis sapien enim, eget placerat nulla auctor vitae. Morbi tempor felis at pretium auctor. Vestibulum consectetur, mauris et tempus aliquet, lectus eros vulputate leo, et accumsan quam purus sed lectus. Sed faucibus tempus ultrices.
                    </p>
                </div>
            </div>

            <div className='bg-red-600 bg-[url(/cta-banner.jpg)] bg-cover h-[500px] rouned-2xl grid place-items-center' >
